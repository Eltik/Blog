            ...
            <section className="flex flex-col px-12 py-8">
                <div className="flex flex-row items-stretch justify-between">
                    ...
                    <div className="flex flex-row items-center justify-center gap-5">
                        <Link href="/login">
                            <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md border border-solid bg-gray-100 px-4 py-1 font-medium">Login</button>
                        </Link>
                        <Link href="/register">
                            <button className="text-base font-light text-white">Register</button>
                        </Link>
                    </div>
                </div>
